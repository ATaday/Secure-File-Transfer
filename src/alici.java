...
public class alici {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			clientKeys.load(new FileInputStream("keystore2.jks"), "alperdogus".toCharArray());
			KeyManagerFactory clientKeyManager = KeyManagerFactory.getInstance("SunX509");
			clientKeyManager.init(clientKeys, "alperdogus".toCharArray());

			KeyStore serverPublic = KeyStore.getInstance("JKS");
			serverPublic.load(new FileInputStream("truststore.jks"), "alperdogus".toCharArray());
