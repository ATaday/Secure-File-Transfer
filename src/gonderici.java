...
public class gonderici {
	public static void main(String[] args) {
		...
		try {
			...
			serverKeys.load(new FileInputStream("keystore.jks"), "alperdogus".toCharArray());
			KeyManagerFactory serverKeyManager = KeyManagerFactory.getInstance("SunX509");
			serverKeyManager.init(serverKeys, "alperdogus".toCharArray());
			
			KeyStore clientPublic = KeyStore.getInstance("JKS");
			clientPublic.load(new FileInputStream("truststore2.jks"), "alperdogus".toCharArray());
